    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnGuardarCambios.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // Crear la frase con los nuevos cambios pero ponerle el id de la anterior
                ...
                FraseFamosa fraseConNuevosCambios = new FraseFamosa(nuevoTexto, nuevoAutor, frase.getId());
                ...
                if (filasModificadas != 1) {
                    ...
                    Toast.makeText(EditarFraseActivity.this, "Error guardando cambios. Intente de nuevo.", Toast.LENGTH_SHORT).show();
                } else {
                // Si las cosas van bien, volvemos a la principal cerrando esta actividad
                    finish();
                }
            }
        });
